...
class BuildExe:
    def __init__(self):
        ...
        #Auhor of program
        self.author_name = "Stefan Seemayer"
        self.author_email = "mail@semicolonsoftware.de"
        self.copyright = "Copyright (c) 2013 Stefan Seemayer"

        #Description
        self.project_description = "Play a swarm of migrating fish in my Ludum Dare 26 entry."

        #Icon file (None will use pygame default icon)
        self.icon_file = "data/images/icon.ico"
